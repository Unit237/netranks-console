...
const AutocompleteBrand: React.FC<Props> = ({ onSelect }) => {
  ...
  return (
    <div className="w-full px-2 sm:px-4">
      ...
      {/* Brand options */}
      <div className="flex flex-col bg-gray-100 dark:bg-gray-700 rounded-[20px] sm:rounded-[26px] mt-5 w-full max-w-[600px] mx-auto">
        {options.map((option) => (
          <div
            key={option.brandId}
...
// RenderBrandItemWithIcon Component mt-20 sm:mt-20 md:mt-28
