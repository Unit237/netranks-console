        ...
        <>
          ...
          <div className="flex flex-wrap gap-2 mt-3">
            ...
            <button
              ...
              className={`bg-orange-500 flex items-center justify-center gap-2 flex-1 rounded-lg px-3 py-1 text-[12px] font-medium transition-colors`}
