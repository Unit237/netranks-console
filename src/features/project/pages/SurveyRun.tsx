      ...
      <div className="max-w-5xl mx-auto">
        ...
        {progress === 100 && (
          <div className="flex flex-col items-center gap-4 relative z-10">
            <button
              onClick={handleShare}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 border-2 border-orange-600 font-medium rounded-lg hover:bg-blue-50 transition-colors duration-200 cursor-pointer z-10 relative"
            >
